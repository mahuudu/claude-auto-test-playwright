---
name: e2e-spec
description: Run steps 1–3 of the E2E pipeline (crawl → spec → test-cases) then STOP for review. Use before /e2e-build to let you edit the spec and test cases first. Arguments: <feature> <page> or <url>.
---
...
Phân tích và tạo `docs/crawl/<feature>/<page>/crawl-data.json` theo schema:
...
In: `✅ docs/crawl/<feature>/<page>/crawl-data.json`
