---
name: fix-test
description: Analyze failed E2E tests from reports/latest.json, read screenshots, classify root cause, fix POM or test file, and re-run. Use when tests are failing after /e2e or after a UI change.
---
