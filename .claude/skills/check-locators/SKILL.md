---
name: check-locators
description: Open the real page with Playwright MCP and verify all locators in a UI map are still working. Use after a UI update or when tests start failing with selector issues. Arguments: <feature> <page>.
---
