---
name: cleanup
description: Remove stale test artifacts — test-results/, playwright-report/, and run reports older than 7 days. Safe to run anytime. Does NOT delete latest.json or spec/ui-map/test-case docs.
---
