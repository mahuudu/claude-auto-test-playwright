---
name: smoke
description: Run only High priority tests across all features. Use for quick sanity check before deploy or after a major change. Faster than full test suite.
---
...
```
npx playwright test --grep "TC-001|TC-002|..." --headed
```

Hoặc nếu nhiều feature, chạy từng file với grep:
```
npx playwright test tests/e2e/<feature>/<page>.spec.ts --grep "TC-" --headed
```
